...
public class InterfaceText {
	...
	public final static String HOW_TO_PLAY = "Benvenuto in BariCrysis\nuna semplice avventura testuale come altre\nIl gioco a vari comandi ma sta a te capire quali siano,\nGUARDA con attenzione ogni luogo ed esplora";
	public final static String CREDITS = "Fabio Resta\nElio Musacchio\nDarioSpinosa";
