...
public class Dialogs {
	...
	public static String[] CANNAVACCIUOLO_B = { "Era un caffe' tradizionale. A Napoli e' importante la tradizione.",
			"Tieni, eccoti la chiave del DIB. Perche' ce l'ho io? Non fare domande", "Adesso me ne vado. ADDIOS!" };
	public static String[] JANITOR_A = { "Vuoi entrare nel dipartimento di fisica?",
			"Ti posso dare le chiavi. Cosa mi dai in cambio?" };
	public static String[] JANITOR_B = { "Tu si che sai fare affari! Eccoti le chiavi" };
	public static String JANITOR_EVENT = "Il bidello si prende la rivista e ti da' le chiavi";
	public static String[] VOLPE = { "Incredibile, c'e' ancora qualcuno li' fuori!",
			"Per spazzare via i dinosauri, possiamo usare i raggi cosmici. Il macchinario e' incompleto, manca un pezzo.",
			"Dovrei averlo lasciato in macchina. Servono anche delle viti per montarlo." };
}
