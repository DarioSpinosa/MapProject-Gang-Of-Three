...
public class Partita {
	...
	public Partita() {
		...
		GenericObject torta = new GenericObject(nomeTorta, "una deliziosa torta", ObjectType.EATABLE, new GestoreAlias(new Name[] {}));
		...
		GenericObject pizza = new GenericObject(nomePizza, "una squisita pizza", ObjectType.EATABLE, new GestoreAlias(new Name[]{}));
		...
		GenericObject birra = new GenericObject(nomeBirra, "una pregiata birra peroni", ObjectType.DRINKABLE, new GestoreAlias(new Name[]{}));
		...
		GenericObject caffe = new GenericObject(NomeCaffe, "E' del caffe in polvere, magari se lo sniffi muori", ObjectType.EVENT);
