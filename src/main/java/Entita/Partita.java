...
public class Partita {
    ...
    public Partita() {
    	...
    	Evento macchinaCaffe = new Evento("Sono le 8 di mattina, dovresti preparati un bel caffe per iniziare questa giornata di merda");
    	macchinaCaffe.addOggettoEvento(new Caffe( new Name("macchinetta", WordType.NOME), "E' una macchina per fare il cazzo di caffe"));
