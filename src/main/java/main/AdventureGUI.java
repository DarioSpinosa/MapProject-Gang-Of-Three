...
public class AdventureGUI extends javax.swing.JFrame {
	...
	private void init() throws IOException, ClassNotFoundException {
		...
		prepositions.addPreposition("con",
				new CommandType[] { CommandType.COMBINA, CommandType.APRI, CommandType.PARLA });
	...
	private void initComponents() {
		...
		jlMinute.setFont(new java.awt.Font("Helvetica", 1, 18)); // NOI18N

		jlSecond.setFont(new java.awt.Font("Helvetica", 1, 18)); // NOI18N
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					AdventureGUI gioco = new AdventureGUI();
